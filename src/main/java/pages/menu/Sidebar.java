...
public class Sidebar {
    ...
    private WebElement menuAirTicketsBtn;//кнопка Меню - авиабилеты

    @AndroidFindBy(id = "ru.s7.android:id/navAeroexpress")
    private WebElement menuAeroexpressBtn;//кнопка Меню - аэроэкспресс

    @AndroidFindBy(id = "ru.s7.android:id/navTransfer")
    private WebElement menuTransferBtn;//кнопка Меню - трансфер

    @AndroidFindBy(id = "ru.s7.android:id/navAuto")
    private WebElement menuAutoBtn;//кнопка Меню - авто

    @AndroidFindBy(id = "ru.s7.android:id/navSettings")
    private WebElement menuSettingsBtn;//кнопка Меню - Настройки

    @AndroidFindBy(id = "ru.s7.android:id/navDebugViews")
    private WebElement menuDebugViewsBtn;
